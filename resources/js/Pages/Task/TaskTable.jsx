                    ...
                    <tbody>
                        ...
                        <tr key={task.id} className="bg-white border-b">
                            ...
                            <th className="px-3 py-2 text-gray-100">
                                <span className={"px-2 py-1 rounded " + TASK_STATUS_CLASS_MAP[task.status]}>
                            ...
                            <td className="px-3 py-2 text-nowrap">
                                <Link href={route('task.edit', task.id)} className="font-medium text-blue-600 hover:underline mx-1">
                                    Edit
                                </Link>
                                    <button
